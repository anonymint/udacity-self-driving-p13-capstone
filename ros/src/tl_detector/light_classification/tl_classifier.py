...
class TLClassifier(object):
    def __init__(self):
        """
            Turn this section on when testing classifier with Model file in ./model folder
        """        
        self.is_site = is_site
        if self.is_site :
            model_path = "light_classification/model/frozen_inference_graph_udacity_car.pb"
        else:
            model_path = "light_classification/model/frozen_inference_graph_simulation_car.pb"
